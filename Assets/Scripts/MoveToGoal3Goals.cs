        ...
        if (other.gameObject.tag == "finish")
        {
            ...
            if (HardRewardMode)
            {
                if (NumGoalsNotChecked != 0)
                {
                    ...
                    SetReward(1f + NumGoalsChecked * 0.5f - NumGoalsNotChecked * 0.5f); // Base Reward for reaching the finish line + Reward for every checked goal + penalty for every unchecked goal
                }
